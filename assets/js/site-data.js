...
const translations = {
  en: {
    ...
    "explorer.note": "Use the slider to extend the arm. Drag horizontally to rotate the view.",
    ...
    "about.viewTapper": "Explore Robo-Tapper",
  ...
  zhHant: {
    ...
    "explorer.note": "使用滑桿伸展機械臂；水平拖曳以旋轉視角。",
    ...
    "about.title": "關於我",
    "about.viewTapper": "探索 Robo-Tapper",
